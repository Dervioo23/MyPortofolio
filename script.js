...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function (e) {
      ...
      // Gunakan pada input form
      const sanitizedMessage = sanitizeInput(message);

      // Here you would typically send the form data to a server
      console.log('Form submitted:', { name, email, message: sanitizedMessage });
  ...
  // Add view all certificates functionality
  const viewAllCertificatesBtn = document.querySelector('#certificates-tab .center-btn .btn');
  const certificatesGrid = document.querySelector('.certificates-grid');

  if (viewAllCertificatesBtn && certificatesGrid) {
    let isExpanded = false;
    const certificateCards = certificatesGrid.querySelectorAll('.certificate-card');

    // Initially hide certificates after the first 3
    ...
    viewAllCertificatesBtn.addEventListener('click', function (e) {
      ...
      if (!isExpanded) {
        ...
        // Hide certificates after the first 3
        certificateCards.forEach((card, index) => {
          if (index >= 3) {
            card.style.opacity = '0';
            card.style.transform = 'translateY(20px)';
        ...
        // Update button text
        this.textContent = 'Lihat Semua Sertifikat';

        // Scroll to certificates section if it's out of view
        const certificatesSection = document.querySelector('#certificates-tab');
  ...
  // Tambahkan debounce untuk event scroll
  ...
  // Add view all projects functionality
  const viewAllProjectsBtn = document.querySelector('#projects-tab .center-btn .btn');
  const projectsGrid = document.querySelector('.projects-grid');

  if (viewAllProjectsBtn && projectsGrid) {
    let isExpanded = false;
    const projectCards = projectsGrid.querySelectorAll('.project-card');

    // Initially hide projects after the first 3
    ...
    viewAllProjectsBtn.addEventListener('click', function (e) {
      ...
      if (!isExpanded) {
        ...
        // Scroll to projects section if it's out of view
        const projectsSection = document.querySelector('#projects-tab');
